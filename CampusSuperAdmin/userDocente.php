...
<?php 
require 'common/usersAgregarDocente.php';  
        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="breadcrumb"  style="padding: 15px;">
                    ...
                    <li><a href="userDocente.php">Usuarios</a></li>
                                ...
                                <form  action="" method="post" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><i class="fa fa-user"></i> Nuevo Docente</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="hidden"  name="txtID" required value="<?php echo $txtID; ?>" placeholder="" id="txtID" require="">
                                                    <input type="hidden"  name="txtNivel" required value="Docente" placeholder="" id="txtNivel" require="">
                    ...
                    <!-- modal -->
                        <a class="btn btn-success" data-toggle="modal" href="#myModal">Agregar Docente +</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="profileEditarTeacher.php?id=<?php echo $usuario['ID'];?>" class="btn btn-primary btn"><i class="fa fa-pencil"></i> Editar </a>
                                    <a href="common/usersEliminarDocente.php?ID=<?php echo $usuario['ID'];?>" class="btn btn-danger btn"><i class="fa fa-trash-o "></i></a>
                                </td>
                            </tr>                             
                            <?php  }  ?>
                        </tbody>
