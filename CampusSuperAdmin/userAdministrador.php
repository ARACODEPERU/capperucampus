...
<?php 
require 'common/usersAgregarAdministrador.php';  
        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="breadcrumb"  style="padding: 15px;">
                                ...
                                <form  action="" method="post" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><i class="fa fa-user"></i> Nuevo Administrador</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="hidden"  name="txtID" required value="<?php echo $txtID; ?>" placeholder="" id="txtID" require="">
                                                    <input type="hidden"  name="txtNivel" required value="Administrador" placeholder="" id="txtNivel" require="">
                    ...
                    <!-- modal -->
                        <a class="btn btn-success" data-toggle="modal" href="#myModal">Agregar Administrador +</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                                <?php
                                    $sentencia= $pdo->prepare("SELECT * FROM users WHERE Nivel='Administrador' ");
                                    $sentencia->execute();
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="profileEditarAdmin.php?id=<?php echo $usuario['ID'];?>" class="btn btn-primary btn"><i class="fa fa-pencil"></i> Editar </a>
                                    <a href="common/usersEliminarAdministrador.php?ID=<?php echo $usuario['ID'];?>" class="btn btn-danger btn"><i class="fa fa-trash-o "></i></a>
                                </td>
                            </tr>
                                <?php  }  ?>
                        </tbody>
