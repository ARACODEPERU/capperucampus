...
<?php 
require 'common/academicAgregarFiles.php';  
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select type="text" 
                                                    class="form-control <?php echo (isset($error['PosicionFiles']))?"is-invalid":"";?>" 
                                                ...
                                                <input type="hidden"  name="txtidThemes" required value="<?php echo $themes['IDThemes'] ?>" placeholder="" id="txtidThemes" require="">        
                                                <?php   }   ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea  type="text" class="form-control <?php echo (isset($error['Enlace']))?"is-invalid":"";?>" 
                                                   name="txtEnlace" value="<?php echo $txtEnlace; ?>" placeholder="" id="txtEnlace"></textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <header class="panel-heading">Lista de Archivos</header>
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tbody>
                                <?php
                                $id = $_REQUEST ['id'];
                                $sentencia= $pdo->prepare("SELECT * FROM files WHERE idThemes='$id' ORDER BY PosicionFiles asc ");
                                $sentencia->execute();
                                $listaFiles=$sentencia->fetchAll(PDO::FETCH_ASSOC);
                                foreach($listaFiles as $files) {  ?>
                                <tr>
                                    <td><?php echo $files['PosicionFiles']; ?></td>
                                    <td><?php echo $files['NombreFiles']; ?></td>
                                    <!--<td style="width: 150px;"><?php echo $files['EnlaceFiles']; ?></td>-->
                                    <td>
                                      <a href="viewFiles.php?id=<?php echo $files['IDFiles'];?>" class="btn btn-success btn"><i class="fa fa-eye"></i></a>
