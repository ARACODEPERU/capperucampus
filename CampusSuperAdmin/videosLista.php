                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select type="text" 
                                                    class="form-control <?php echo (isset($error['PosicionVideos']))?"is-invalid":"";?>" 
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="wysihtml5 form-control" <?php echo (isset($error['Enlace']))?"is-invalid":"";?> 
                                                rows="5"  name="txtEnlace" id="txtEnlace" require=""></textarea>
                    ...
                    <header class="panel-heading">Lista de Videos</header>
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tbody>
                                ...
                                <?php
                                $id = $_REQUEST ['id'];
                                $sentencia= $pdo->prepare("SELECT * FROM videos WHERE idThemes='$id' ORDER BY PosicionVideos asc ");
                                $sentencia->execute();
