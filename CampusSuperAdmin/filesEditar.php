...
?> 
    ...
    <?php
        $id = $_REQUEST ['id'];
        $sentencia= $pdo->prepare("SELECT * FROM files WHERE IDFiles ='$id'");
        $sentencia->execute();
            ...
            <aside class="profile-nav col-lg-3">
                <section class="panel">
                    <div class="user-heading round">
                        <a href="#"><img  src="../img/archivos.jpg" alt=""></a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <select type="text" 
                                                    ...
                                                    <input type="hidden"  name="txtidThemes" required value="<?php echo $files['idThemes']; ?>" placeholder="" id="txtidThemes" require="">        
                                               
                                            <div class="col-md-9">
                                                <label for="">Título del Archivo: *</label>
                                                <input type="text" class="form-control" 
                                                            name="txtNombre" value="<?php echo $files['NombreFiles']; ?>" require="">
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="wysihtml5 form-control" rows="5"  name="txtEnlace"><?php echo $files['EnlaceFiles']; ?></textarea>
                                            </div>
                                        </div>
