        ...
        <div class="row">
            <div class="col-md-9">
                <ul class="breadcrumb">
                    ...
                    <li><a href="userAlumno.php">Usuarios</a></li>
                                ...
                                <form  action="" method="post" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><i class="fa fa-user"></i> Nuevo Alumno</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="hidden"  name="txtID" required value="<?php echo $txtID; ?>" placeholder="" id="txtID" require="">
                                                    <input type="hidden"  name="txtNivel" required value="Alumno" placeholder="" id="txtNivel" require="">
                    ...
                    <!-- modal -->
                        <a class="btn btn-success" data-toggle="modal" href="#myModal">Agregar Alumno +</a>
                    </li>
                </ul>
                <form class="form-horizontal breadcrumb" action="searchAlumno.php" method="post">
                    <div class="row">
                        <label  class="col-md-3 control-label">Buscar Alumno:</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" placeholder="Ingresar DNI" name="dni">
                        </div>
                        <div class="col-md-3">
                            <button type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-eye-open"></span> Buscar Registro</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            <?php
                                $dni = $_POST['dni'];
                                $nivel = 'Alumno';
                                $sentencia= $pdo->prepare("SELECT * FROM users WHERE dni='$dni' AND nivel='$nivel' ");
                                $sentencia->execute();
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="profileEditarAlumno.php?id=<?php echo $usuario['ID'];?>" class="btn btn-primary btn"><i class="fa fa-pencil"></i> Editar </a>
                                    <a href="common/usersEliminarAlumno.php?ID=<?php echo $usuario['ID'];?>" class="btn btn-danger btn"><i class="fa fa-trash-o "></i></a>
                                </td>
                            </tr>
                            <?php  }  ?>
                        </tbody>
