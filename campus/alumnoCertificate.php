              ...
              <section class="panel">
                  ...
                  <i class="fa  fa-graduation-cap"></i> <b> Mis Certificados</b>
                            ...
                            <div class="row">
                                <?php
                                    $id = $_SESSION ['ID'];
                                    $query = "SELECT DISTINCT ce.image image , ce.content link_pdf, DISTINCT c.image imageCourses FROM users u join people p on p.id=u.person_id join aca_students stu on stu.person_id=p.id 
