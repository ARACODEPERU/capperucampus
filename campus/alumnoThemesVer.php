...
<meta name="description" content="Pragot">
<meta name="author" content="Pragot">
                              ...
                              <div class="state-overview">
                                  <section class="panel">
                                      <div class="symbol red" style="width: 20%; padding: 0px;">
                                          <a class="btn" style=" color: #fff;" href="alumnoClass.php?id=<?php echo $row['IDThemes'];?>">
                                          <i class="fa fa-book"></i> <br/>
                                          Ingresar</a>
                                      </div>
                                      <a href="alumnoClass.php?id=<?php echo $id;?>">
