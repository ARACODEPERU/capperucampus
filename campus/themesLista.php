                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="common/acadEliminarThemes.php?id=<?php echo $themes['id'];?>" class="btn btn-danger btn" onclick="confirmDelete(event, 'common/acadEliminarThemes.php?id=<?php echo $themes['id'];?>')"><i class="fa fa-trash-o "></i></a>
                                   </td>
                                </tr>
                                <?php  }  ?>
                              </tbody>
...
<script>
            function confirmDelete(event, ruta) {
                        ...
                        Swal.fire({
                        title: '¿En Realidad quieres borrar este Tema?',
                        showDenyButton: true,
