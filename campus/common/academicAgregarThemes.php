...
$txtidModules=(isset($_POST['txtidModules']))?$_POST['txtidModules']:"";
...
include ("common/conexion.php");
    ...
    switch($accion){
        case "btnAgregar":
            ...
            if($txtidModules==""){ 
                $error['idModules']="Ingresar el idModules";
            }

            if($txtNombre==""){ 
                $error['Nombre']="Escribir titulo del modulo";
            }
            ...
            $sentencia=$pdo->prepare("INSERT INTO themes(PosicionThemes, idModules, NombreThemes) 
            VALUES (:Posicion, :idModules, :Nombre)");

            $sentencia->bindParam(':Posicion',$txtPosicion);
            $sentencia->bindParam(':idModules',$txtidModules);
