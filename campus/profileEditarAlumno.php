            ...
            <aside class="profile-info col-lg-9">
                <section class="panel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-row">
                                <form  action="common/usersModificarAlumno.php?id=<?php echo $usuario['ID']; ?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-header">
                                            <h4 class="modal-title"><i class="fa fa-user"></i> Editar Alumno</h4>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                              <a href="userAlumno.php" class="btn btn-default" type="button">Regresar</a>
